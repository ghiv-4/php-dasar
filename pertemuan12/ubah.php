        ...
        <ul>
            <li>
                <label for= 'nama'> Nama :</label>
                 <input type='text' name='nama' id='nama' required value= "<?= $akt["nama"]; ?>"> <!-- buat isian masing-masing field  -->
            </li>
            <li>
            ...
            <li>
                <label for= 'ukuran bra'> Ukuran Bra :</label>
                 <input type='text' name='ukuran bra' id='ukuran bra' required value= "<?= $akt["bra"]; ?>">
            </li>
            <li>
            ...
            <li>
                <label for= 'debut'> Debut :</label>
                 <input type='text' name='debut' id='debut' value= "<?= $akt["debut"]; ?>">
            </li>
            <label for= 'gambar'> Gambar :</label>
             <input type='text' name='gambar' id='gambar' value= "<?= $akt["gambar"]; ?>">
            <li>
